...
===============================================================================
Purpose:
    This procedure handles the ETL process needed to move data from the Bronze 
    layer into the Silver layer. It prepares clean, standardized versions of the 
    raw tables to support downstream integration and analysis.

What It Does:
    - Truncates existing Silver tables before loading
    - Inserts cleaned, validated, and transformed records from Bronze tables

Parameters:
    None.
    The procedure does not take any inputs and does not return any outputs.
